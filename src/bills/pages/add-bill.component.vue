    ...
    createBill() {
      ...
      this.billsApi.create(this.bill)
          .then((response) => {
            ...
            this.$toast.add({severity: 'success', summary: 'Success', detail: 'La factura se ha añadido con éxito', life: 3000});
        ...
        <div class="p-fluid form-grid-2">
          <div class="field mt-5">
            <pv-float-label>
              ...
              <pv-input-text id="startDate" v-model="startDate" :class="{'p-invalid': !startDate}" type="datetime-local" :max="expirationDate"/>
            </pv-float-label>
          </div>
          <div class="field mt-5">
            <pv-float-label>
